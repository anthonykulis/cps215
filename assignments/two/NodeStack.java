...
public class NodeStack<T> implements StackInterface<T>{
  ...
  public static void main(String args[]){
    ...
    /* Homework solution tests */
    String[] numbers = {"One", "Two", "Three"};
    ns.push(numbers);

    if(ns.isEmpty()){
      throw new RuntimeException("I just pushed three at once but stack is empty");

    }
    Object[] numbersPopped = ns.pop(3);
    if(numbersPopped.length != 3){
      throw new RuntimeException("I just popped the entire stack of three and got back something not 3");
    }
